...
const GCR_SERVICE_URL = "projects/parallel-dynamic-runtime-tf/locations/us-central1/services/ci-dagger-app"
const GCR_PUBLISH_ADDRESS = "gcr.io/parallel-dynamic-runtime-tf/ci-dagger-app"
